...
dynamic altezza2 = 1.70; // dichiarzione e inizializzazione di una variabile di tipo dynamic
...
// inseimento di valori nell array
...
// in questo caso string e la chiave ed int il valore
...
string nome9 = "Nome1";
Console.Write(nome9.Contains("Nom")); // output: True
...
// se la conversione non e riuscita viene generata un eccezione di tipo FormaException ed il programma si blocca
string eta4 = "10";
...
// Convertire un tipo di dato in un altro tipo dio dato