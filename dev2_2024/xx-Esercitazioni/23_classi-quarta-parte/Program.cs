...
class Program
{
    static void Main(string[] args)
    {
        ...
        manager.AggiungiProdotto(new ProdottoAdvanced { Id = 2, NomeProdotto = "Prodotto B", PrezzoProdotto = 10.50m, GiacenzaProdotto = 50 });
        ...
        manager.AggiornaProdotto(idProdottoAggiornare, nuovoProdotto);
...
{
    // la classe ProdottoRepository è una classe che si occupa
    // 
    //
    //
    //
